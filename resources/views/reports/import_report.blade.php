...
@section('content')
    ...
    <h2 id="tr" class="text-center">Delivery Report (Import)</h2>
        ...
        $(function() {
            ...
            function load_data(from_date = '', to_date = '', agent_id = '')
            {
                $('#all_report').DataTable({
                    ...
                    buttons: [
                        {
                            extend: 'pdf',
                            messageTop: 'Delivery Report (Import)',
                            footer: true
                        },
                        'csv',
                        'excel',
                        {
                            extend: 'print',
                            messageTop: '<h2>Delivery Report (Import) ' +customer_name+ '</h2>',
                            footer: true
                        }
                    ],
                    ajax: {
                        url:'{!! route("get_import_report") !!}',
            ...
            $('#filter').click(function(){
                ...
                if (agent_id != ''){
                    ...
                    document.getElementById("tr").innerHTML = 'Delivery Report (Import)'+customer_name;
                }else {
                    customer_name = '';
                    document.getElementById("tr").innerHTML = 'Delivery Report (Import)'+customer_name;
                }
