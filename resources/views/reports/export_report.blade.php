...
@section('content')
    ...
    <h2 id="tr" class="text-center">Delivery Report (Export)</h2>
        ...
        $(function() {
            ...
            function load_data(from_date = '', to_date = '', agent_id = '')
            {
                $('#all_report').DataTable({
                    ...
                    buttons: [
                        {
                            extend: 'pdf',
                            messageTop: 'Delivery Report (Export)',
                            footer: true
                        },
                        'csv',
                        'excel',
                        {
                            extend: 'print',
                            messageTop: '<h2>Delivery Report (Export) ' +customer_name+ '</h2>',
                            footer: true
                        }
                    ],
                    ajax: {
                        url:'{!! route("get_export_report") !!}',
            ...
            $('#filter').click(function(){
                ...
                if (agent_id != ''){
                    ...
                    document.getElementById("tr").innerHTML = 'Delivery Report (Export)'+customer_name;
                }else {
                    customer_name = '';
                    document.getElementById("tr").innerHTML = 'Delivery Report (Export)'+customer_name;
                }
